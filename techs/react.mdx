...
<Note>If you have an advanced React workspace or you are a senior developer, remember not to show hardcoded IDs. Use a more secure pattern, for example, using an .env file and reading from it "workspace_id".</Note>
