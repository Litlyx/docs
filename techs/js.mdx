...
## 1. Install
With this line of code in your `index.html`, inside the `body` tag, you can already collect analytics like `Page Visits`, `Referrers`, `Avarage Session Time` and many more.
